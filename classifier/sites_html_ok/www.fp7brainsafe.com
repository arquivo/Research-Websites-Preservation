...
<div class="form-actions form-wrapper" id="edit-actions"><input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-vw6-2XFH9QzQfVyBfUvuITewpiqcoQ_AD6XWiwALYyU" />
...
</ul></div><input type="hidden" name="form_build_id" value="form-Zec9V8qDvBZ-XU4PalNrm3xHBikdHT4xU3O4sBVONdA" />
