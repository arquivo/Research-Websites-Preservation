...
<div class="form-actions form-wrapper" id="edit-actions"><input type="submit" id="edit-submit" name="op" value="Search" class="form-submit" /></div><input type="hidden" name="form_build_id" value="form-oTRwQiwG2P0Hzhr4I-70Q6-q39qxIFhraPfzOWp4VI4" />
...
</ul></div><input type="hidden" name="form_build_id" value="form-qv5szg-zEaQH4WmBUp0N-tcwLlpo23HEawCU0W1nbJo" />
