...
<meta name="description" content="Legiotex® es un filtro de tejido no-tejido antibacteriano que retiene y condensa los aerosoles que portan la bacteria Legionella pneumophilla, y la elimina por contacto." />
	<title>Legiotex®, filtro antibacteriano de tejido no-tejido | Logrotex</title>

	<link type="text/css" rel="stylesheet" media="all" href="/files/css/css_b3ed0af942ea1b2ba799954321959aea.css" />
	<script type="text/javascript" src="/sites/all/modules/jquery_update/replace/jquery.min.js?o"></script>
<script type="text/javascript" src="/misc/drupal.js?o"></script>
<script type="text/javascript" src="/files/languages/es_dc10b17e180bb74e9dcb4b05149d0896.js?o"></script>
<script type="text/javascript" src="/sites/all/themes/tema_logrotex/js/template.js?o"></script>
...
<body class="body_anonimo body_interior">
		...
		<div class="contenedor">
			<div class="contenedor_interior">
				...
				<div id="language-interface"><a href="/es/productos/legiotex" class="active es">Español</a><img src="/sites/all/themes/tema_logrotex/img/menu_tecnico_separador.jpg" alt="" /><a href="/en/products/legiotex" class="en">English</a><img src="/sites/all/themes/tema_logrotex/img/menu_tecnico_separador.jpg" alt="" /><a href="/fr/produits/legiotex" class="fr">Français</a></div>				<div id="menu_tecnico">
					<div id="buscador">
...
</div><input type="hidden" name="form_build_id" id="form-YAm-G8TKhK6w9YHAC2mgE9xdY1FQUEyXV8rqJxRatJc" value="form-YAm-G8TKhK6w9YHAC2mgE9xdY1FQUEyXV8rqJxRatJc"  />
...
<li class="leaf"><a href="/descargas" title="DESCARGAS">DESCARGAS</a></li>
<li class="leaf"><a href="/proyectos-idi" title="PROYECTOS I+D+I">PROYECTOS I+D+i</a></li>
<li class="leaf last"><a href="/actualidad" title="ACTUALIDAD">ACTUALIDAD</a></li>
</ul><div class="limpiar"></div>			</div>
		</div>
	</nav>
	...
	<div id="migas">
		<div class="contenedor">
			<div class="contenedor_interior">
				<span>Logrotex: </span><div class="breadcrumb"><a href="/">Inicio</a> › <a href="/productos" title="Productos">Productos</a> › <a href="/productos/legiotex" class="active">Legiotex</a></div>			</div>
		</div>
	</div>
...
<div class="columnas_linea columnas_linea_legiotex">
  ...
  <ul class="menu"><li class="leaf first menu-mlid-288 active"><a href="/productos/legiotex" title="Descripción" class="active">Descripción</a></li>
...
<li class="leaf menu-mlid-298"><a href="/productos/legiotex/ventajas" title="Ventajas de Legiotex<sup>&reg;</sup>">Ventajas</a></li>
...
<li class="leaf last menu-mlid-680"><a href="/productos/legiotex/video" title="Video promocional">Vídeo promocional</a></li>
	...
	<div class="derecha">
		<h1>Qué es Legiotex<sup>&reg;</sup></h1>
		<div class="derecha_interior">
							<div class="catalogo_descarga">
					<p><img src="/sites/all/themes/tema_logrotex/img/catalogo-pdf.jpg" alt="" /> <a rel="external" href="/files/uploads/catalogos/catalogo-legiotex-es.pdf" title="Descarga nuestro catálogo" onclick="_gaq.push(['_trackEvent', 'Catalogos', 'Descarga', 'legiotex']);">Descarga nuestro catálogo</a></p>
				</div>
				<p><img alt="Logotipo de Legiotex" src="/files/uploads/legiotex/legiotex-esp.png" /></p>
<p>Legiotex<sup>&reg;</sup> es un filtro de tejido no-tejido antibacteriano que retiene y condensa los aerosoles que portan la bacteria Legionella pneumophilla, y la elimina por contacto.</p>
<p>La exclusiva combinaci&oacute;n de fibras antibacterianas del no-tejidoLegiotex<sup>&reg;</sup> proporciona una porosidad id&oacute;nea para la retenci&oacute;n de las micro-gotas de agua (2-5 micras) transportadoras de la bacteria, y los tratamientos espec&iacute;ficos le proporcionan una larga vida &uacute;til y resistencia a las condiciones clim&aacute;ticas.</p>
<p>De estructura esponjosa, y obtenido mediante la tecnolog&iacute;a air-lay, naceLegiotex<sup>&reg;</sup>, un filtro capaz de minimizar la posibilidad de contagio de la enfermedad. Su f&aacute;cil instalaci&oacute;n en los conductos de admisi&oacute;n y salida de aire en las torres de refrigeraci&oacute;n, condensadores evaporativos y otros sistemas, previene la dispersi&oacute;n de micro-gotas de agua contaminadas a la atm&oacute;sfera.</p>
		</div>
	</div>
		...
		<div id="prepie">
			<div class="contenedor">
				<div class="contenedor_interior">
					...
					<p class="legal"><a href="/politica-de-privacidad" title="">POLíTICA DE PRIVACIDAD</a></p>
			...
			<div class="contenedor">
				<div class="contenedor_interior">
					<div id="datos_contacto">
						<p>C/Alberite, 11-17 . 26006 . Logroño (La Rioja) . España<br />Tfno: +34 941 211 211 &#46; Fax: +34 941 210 347</p>
