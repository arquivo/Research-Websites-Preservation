...
<head id="ctl00_ctl00_Head1"><title>
	fighting-aneurysm.org - Registered at Namecheap.com
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUENTM4MWRk8r4F8y2QVRoUvIJWkD7RnqLX0LuaSTe9DEb13MDgBEI=" />
		...
		<div id="holder">
				<div id="header">
					<div class="width">
						...
						<h1 id="domaintitle"><a href="#">fighting-aneurysm.org</a></h1>
					</div>
				</div><!--header-->
